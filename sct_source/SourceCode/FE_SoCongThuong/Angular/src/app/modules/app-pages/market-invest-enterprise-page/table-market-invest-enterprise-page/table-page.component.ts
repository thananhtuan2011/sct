...
import { EditMarketInvestEnterpriseModalComponent } from './components/edit-market-invest-enterprise-modal/edit-modal.component';
...
export class TableMarketInvestEnterprisePageComponent implements OnInit,
  OnDestroy,
  ICreateAction,
  IEditAction,
  IDeleteAction,
  ...
  constructor(
    ...
    public pageService: MarketInvestEnterprisePageService,
  ...
  filterForm() {
    this.filterGroup = this.fb.group({
      ...
      Investment: ['00000000-0000-0000-0000-000000000000'],
    });
    this.show = true;
    ...
    this.subscriptions.push(
      this.filterGroup.controls.Investment.valueChanges.subscribe(() => this.filter())
    );
  }
  ...
  filter() {
    ...
    const investment = this.filterGroup.controls['Investment'].value;
    ...
    if (investment && investment != "00000000-0000-0000-0000-000000000000") {
  ...
  resetFilter() {
    ...
    this.filterGroup.controls.Investment.reset('00000000-0000-0000-0000-000000000000');
    this.pageService.fetch();
  }
  ...
  edit(item: any) {
    const modalRef = this.modalService.open(EditMarketInvestEnterpriseModalComponent, { size: 'lg' });
    if (item) {
  ...
  exportFile() {
    ...
    const fileName = "QuanLyChoDoDoanhNghiep_HTX_DauTu_" + timeString + ".xlsx"
    ...
    this.http.post(`${environment.apiUrl}/MarketInvestEnterprise/Export`, query, {
      responseType: 'blob',
    }).pipe(
