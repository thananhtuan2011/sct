...
import { MarketPlanInformationPageRoutingModule } from './market-plan-information-page-routing.module';
...
import { EditMarketPlanInformationModalComponent } from './table-market-plan-information-page/components/edit-market-plan-information-modal/edit-modal.component';
...
@NgModule({
  declarations: [
    MarketPlanInformationPageComponent,
    TableMarketPlanInformationPageComponent,
    EditMarketPlanInformationModalComponent,
  ],
  providers: [
    MarketPlanInformationPageService
	],
  imports: [
    MarketPlanInformationPageRoutingModule,
    CommonModule,
    InlineSVGModule,
    NgbModule,
    FormsModule,
...
export class MarketPlanInformationPageModule {}