...
@Component({
  selector: 'app-edit-conveniencestore-modal',
  templateUrl: './edit-conveniencestore-modal.component.html',
  styleUrls: ['./edit-conveniencestore-modal.component.scss'],
})

export class EditCommercialManagementConvenienceStoreModalComponent implements OnInit, OnDestroy {
  @Input() id: any;
  @Input() typeId: any;
  @Input() code: any;
  @Input() name: any;
