...
import { StatisticalImportExportDistrictPageRoutingModule } from './statistical-importexport-district-page-routing.module';
...
@NgModule({
  declarations: [
    StatisticalImportExportDistrictPageComponent,
    TableStatisticalImportExportDistrictPageComponent,
  ],
  providers: [
    StatisticalImportExportDistrictPageService,
    // MatNativeDateModule
	],
  
  imports: [
    CommonModule,
    StatisticalImportExportDistrictPageRoutingModule,
    InlineSVGModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
...
export class StatisticalImportExportDistrictPageModule {}