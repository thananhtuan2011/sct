...
export class CateInvestmentProjectPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CateInvestmentProject`;
  ...
  deleteCateInvestmentProject(id: string): Observable<any> {
