...
import { EditCateProjectModalComponent } from './cate-project-page/components/edit-cate-project-modal/edit-cate-project-modal.component';
import { TableCateProjectModalComponent } from './cate-project-page/table-cate-project-page.component';
import { CateProjectRoutingModule } from './cate-project-page-routing.module';
...
@NgModule({
  declarations: [
    TableCateProjectModalComponent,
    EditCateProjectModalComponent,
    CateProjectComponent
  ],
  providers: [
    CateProjectPageService,
    { provide: NgbDateAdapter, useClass: CustomAdapter },
		{ provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter },
	],
  imports: [
    CommonModule,
    CateProjectRoutingModule,
    InlineSVGModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
