...
import { EditMarketPlanInformationModalComponent } from './components/edit-market-plan-information-modal/edit-modal.component';
...
export class TableMarketPlanInformationPageComponent implements OnInit,
  OnDestroy,
  ICreateAction,
  IEditAction,
  IDeleteAction,
  ...
  constructor(
    ...
    public pageService: MarketPlanInformationPageService,
  ...
  ngOnInit(): void {
    this.loadConstructionProperty();
    this.loadConstructionNeed();
    this.loadDistrict();
    this.loadCommune();
    this.filterForm();
    this.searchForm();
  ...
  edit(item: any) {
    const modalRef = this.modalService.open(EditMarketPlanInformationModalComponent, { size: 'lg' });
    if (item) {
    ...
    modalRef.componentInstance.constructionPropertyData = this.constructionPropertyData;
    modalRef.componentInstance.constructionNeedData = this.constructionNeedData;
  ...
  exportFile() {
    ...
    const fileName = "QuanLyThongTinChoQuyHoach_" + timeString + ".xlsx"
    ...
    this.http.post(`${environment.apiUrl}/MarketPlanInformation/Export`, query, {
      responseType: 'blob',
    }).pipe(
  ...
  loadConstructionProperty(){
    this.subscriptions.push(this.commonService.GetConfig('CONSTRUCTION_PROPERTY').subscribe((res: any) => {
      const data = [
        {
          id: '00000000-0000-0000-0000-000000000000',
          text: '-- Chọn --'
      ...
      this.constructionPropertyData = data;
    }))
  }
  
  loadConstructionNeed(){
    this.subscriptions.push(this.commonService.GetConfig('CONSTRUCTION_NEED').subscribe((res: any) => {
      const data = [
        {
          id: '00000000-0000-0000-0000-000000000000',
          text: '-- Chọn --'
      ...
      this.constructionNeedData = data;
    }))
  }
}
