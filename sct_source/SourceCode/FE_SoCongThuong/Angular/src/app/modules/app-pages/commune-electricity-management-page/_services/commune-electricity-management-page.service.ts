...
export class EditCommuneElectricityManagementPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CommuneElectricityManagement`;
