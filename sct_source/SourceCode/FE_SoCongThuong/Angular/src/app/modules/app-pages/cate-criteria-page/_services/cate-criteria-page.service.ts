...
export class CateCriteriaPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CateCriteria`;
  ...
  deleteCateCriteria(id: string): Observable<any> {
    const httpHeaders = this.auth.getHTTPHeaders();
