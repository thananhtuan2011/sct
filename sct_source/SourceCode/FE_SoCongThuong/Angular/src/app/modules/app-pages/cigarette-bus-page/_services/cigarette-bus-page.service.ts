...
export class CigaretteBusinessPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CigaretteBusiness`;
  ...
  deleteCigaretteBusiness(id: string): Observable<any> {
    const httpHeaders = this.auth.getHTTPHeaders();
