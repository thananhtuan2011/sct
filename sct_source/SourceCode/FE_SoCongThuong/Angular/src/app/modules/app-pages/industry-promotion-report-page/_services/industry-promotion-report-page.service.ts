...
export class IndustryPromotionReportPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/IndustrialPromotionFundingReport`;
