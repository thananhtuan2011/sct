...
import { RPIndustrialModule } from './RP-industrial-page-routing.module';
import { EditRPIndustrialModalComponent } from './RP-industrial-page/components/edit-RP-industrial-modal/edit-RP-industrial-modal.component';
...
@NgModule({
  declarations: [
    RPIndustrialComponent,
    EditRPIndustrialModalComponent,
    TableRPIndustrialComponent
  ],
  providers: [
    RPIndustrialPageService,
...
export class RPIndustrialsModule {}