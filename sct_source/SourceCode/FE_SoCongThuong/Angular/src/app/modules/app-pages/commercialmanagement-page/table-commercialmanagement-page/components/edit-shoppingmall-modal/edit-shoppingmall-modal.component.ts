...
const EMPTY_CUSTOM: CommercialManagementModel = {
  ...
  address: '',
  rankId: '',
  constructiveNatureId: '00000000-0000-0000-0000-000000000000',
  businessNatureId: '',
  typeOfEconomic: '00000000-0000-0000-0000-000000000000',
  managementFormId: '00000000-0000-0000-0000-000000000000',
  managementObjectId: '00000000-0000-0000-0000-000000000000',
  phoneNumber: '',
  email: '',
  fax: '',
  note: '',
...
@Component({
  selector: 'app-edit-shoppingmall-modal',
  templateUrl: './edit-shoppingmall-modal.component.html',
  styleUrls: ['./edit-shoppingmall-modal.component.scss'],
})

export class EditCommercialManagementShoppingMallModalComponent implements OnInit, OnDestroy {
  @Input() id: any;
  @Input() typeId: any;
  @Input() code: any;
  @Input() name: any;
  ...
  private prepareCommercialManagement() {
    ...
    this.commercialmanagementData.typeOfEconomic = formData.TypeOfEconomic;
