...
import { StatisticalPetroleumPageRoutingModule } from './statistical-petroleum-page-routing.module';
...
@NgModule({
  declarations: [
    StatisticalPetroleumPageComponent,
    TableStatisticalPetroleumPageComponent,
  ],
  providers: [
    StatiscialPetroleumPageService,
    MatNativeDateModule,
  ...
  imports: [
    CommonModule,
    StatisticalPetroleumPageRoutingModule,
    InlineSVGModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
...
export class StatiscialPetroleumPageModule {}