...
export class ResultsIndustrialPromotionVotingPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/ResultsIndustrialPromotionVoting`;
