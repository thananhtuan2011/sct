...
export class CateIndustrialClusterPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CateIndustrialCluster`;
  ...
  deleteCateIndustrialCluster(id: string): Observable<any> {
