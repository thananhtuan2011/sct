...
export class MonthReportPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/ManagementElectricityActivitiesMonthReport`;
