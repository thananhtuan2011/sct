import { InfoCateRetailModalComponent } from './components/info-cate-retail-modal/info-cate-retail-modal.component';
...
import { EditCateRetailModalComponent } from './components/edit-cate-retail-modal/edit-cate-retail-modal.component';
import { CateRetailPageService } from '../_services/cate-retail.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-table-inter-commerce-page',
  templateUrl: './table-cate-retail-page.component.html',
  styleUrls: ['./table-cate-retail-page.component.scss']
})

export class TableCateRetailModalComponent implements OnInit,
  OnDestroy,
  ICreateAction,
  IEditAction,
  IDeleteAction,
  ...
  constructor(
    ...
    public pageService: CateRetailPageService,
  ...
  edit(id: any) {
    const modalRef = this.modalService.open(EditCateRetailModalComponent, { size: 'xl' });
  ...
  view(id: any) {
    const modalRef = this.modalService.open(InfoCateRetailModalComponent, { size: 'xl' });
    modalRef.componentInstance.id = id;
    modalRef.result.then(() =>
      this.pageService.fetch(),
      () => { }
