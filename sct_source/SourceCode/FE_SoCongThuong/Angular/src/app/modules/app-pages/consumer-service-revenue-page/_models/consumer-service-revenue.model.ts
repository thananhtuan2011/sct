...
export interface ConsumerServiceRevenueModel extends BaseModel {
  consumerServiceRevenueCode : string;
  consumerServiceRevenueId : string;
  checkUserId : any;
  confirmUserId : any;
  createUserId : any;
  confirmTime : any;
...
export interface ConsumerServiceRevenueDetailModel extends BaseModel {
