...
export class TradeFairOrganizationCertificationPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/TradeFairOrganizationCertification`;
