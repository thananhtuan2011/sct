...
export class RPOSOfConstructionPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/RPOSOfConstructionInvestmentProjects`;
