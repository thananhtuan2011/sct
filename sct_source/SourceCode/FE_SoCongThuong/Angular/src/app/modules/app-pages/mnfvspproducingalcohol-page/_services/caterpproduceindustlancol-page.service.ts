...
export class CateRPProduceIndustlAncolPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/CateRPProduceIndustlAncol`;
