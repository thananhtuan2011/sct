...
import { RPOSOfInvestmentnModule } from './RP-of-investment-page-routing.module';
...
import { EditRPOSOfInvestmentnModalComponent } from './RP-of-investment-page/components/edit-RP-of-investment-modal/edit-RP-of-investment-modal.component';
...
@NgModule({
  declarations: [
    RPOSOfInvestmentnComponent,
    EditRPOSOfInvestmentnModalComponent,
    TableRPOSOfInvestmentnComponent
  ],
  providers: [
    RPOSOfInvestmentnPageService,
    { provide: NgbDateAdapter, useClass: CustomAdapter },
		{ provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter },
	],
  imports: [
    CommonModule,
    RPOSOfInvestmentnModule,
    InlineSVGModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
...
export class RPOSOfInvestmentnsModule {}