...
import { EditCateIndustrialClusterModalComponent } from './components/edit-cate-industrial-cluster-modal/edit-modal.component';
...
export class TableCateIndustrialClusterPageComponent implements OnInit,
  OnDestroy,
  ICreateAction,
  IEditAction,
  IDeleteAction,
  ...
  constructor(
    ...
    public cateInvestmentProjectPageService: CateIndustrialClusterPageService,
  ...
  edit(id: any) {
    const modalRef = this.modalService.open(EditCateIndustrialClusterModalComponent, { size: 'lg' });
  ...
  delete(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.isLoading = true;
        const sb = this.cateInvestmentProjectPageService.deleteCateIndustrialCluster(id).pipe(
          tap((res) => {
            Swal.fire({
  ...
  exportFile() {
    ...
    const fileName = "QuanLyCumCongNghiep_" + timeString + ".xlsx"
    ...
    this.http.post(`${environment.apiUrl}/CateIndustrialCluster/Export`, query,
    {
      responseType: 'blob',
    }).pipe(
