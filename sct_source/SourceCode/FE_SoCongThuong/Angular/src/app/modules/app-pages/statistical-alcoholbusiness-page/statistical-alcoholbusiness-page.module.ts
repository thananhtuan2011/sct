...
import { StatisticalAlcoholBusinessPageRoutingModule } from './statistical-alcoholbusiness-page-routing.module';
...
@NgModule({
  declarations: [
    StatisticalAlcoholBusinessPageComponent,
    TableStatisticalAlcoholBusinessPageComponent,
  ],
  providers: [
    StatisticalAlcoholBusinessPageService,
    MatNativeDateModule,
  ...
  imports: [
    CommonModule,
    StatisticalAlcoholBusinessPageRoutingModule,
    InlineSVGModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
...
export class StatisticalAlcoholBusinessPageModule {}