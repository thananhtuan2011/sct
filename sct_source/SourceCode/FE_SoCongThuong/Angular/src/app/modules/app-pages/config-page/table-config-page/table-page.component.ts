...
import { EditGroupConfigModalComponent } from './components/edit-group-config-modal/edit-modal.component';
import { EditConfigModalComponent } from './components/edit-config-modal/edit-modal.component';
...
export class TableGroupConfigPageComponent implements OnInit,
OnDestroy,
ICreateAction,
IEditAction,
IDeleteAction,
...
IFilterView {
  ...
  constructor(
    ...
    public pageService: GroupConfigPageService,
  ...
  edit(item: any) {
    const modalRef = this.modalService.open(EditGroupConfigModalComponent, { size: 'lg' });
    if(item) {
  ...
  change(item: any) {
    const modalRef = this.modalService.open(EditConfigModalComponent, { size: 'lg' });
    modalRef.componentInstance.id = item.categoryTypeId;
    modalRef.componentInstance.typeCode = item.categoryTypeCode;
    modalRef.componentInstance.title = item.categoryTypeName;
    modalRef.result.then(() =>
      this.pageService.fetch(),
      () => { }
