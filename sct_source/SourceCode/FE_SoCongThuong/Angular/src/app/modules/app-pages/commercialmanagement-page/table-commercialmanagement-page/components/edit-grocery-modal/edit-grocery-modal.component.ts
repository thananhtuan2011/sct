...
@Component({
  selector: 'app-edit-grocery-modal',
  templateUrl: './edit-grocery-modal.component.html',
  styleUrls: ['./edit-grocery-modal.component.scss'],
})

export class EditCommercialManagementGroceryModalComponent implements OnInit, OnDestroy {
  @Input() id: any;
  @Input() typeId: any;
  @Input() code: any;
  @Input() name: any;
