...
export class MultiLevelSalesParticipantsPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/MultiLevelSalesParticipants`;
