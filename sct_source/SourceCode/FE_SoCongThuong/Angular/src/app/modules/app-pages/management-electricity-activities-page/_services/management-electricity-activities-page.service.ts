...
export class ManagementElectricityActivitiesPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/ManagementElectricityActivities`;
