...
export class ProcessAdministrativeProceduresPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/ProcessAdministrativeProcedures`;
  ...
  public loadField() {
    ...
    return this.http.get<any>(this.API_URL + '/loadfield',
      {
        headers: httpHeaders
      });
  }
