...
import { EditChemicalSafetyCertificateModalComponent } from './components/edit-chemical-safety-certificate-modal/edit-modal.component';
...
export class TableChemicalSafetyCertificatePageComponent implements OnInit,
OnDestroy,
ICreateAction,
IEditAction,
IDeleteAction,
...
IFilterView {
  ...
  constructor(
    ...
    public pageService: ChemicalSafetyCertificatePageService,
  ...
  edit(id: any) {
    const modalRef = this.modalService.open(EditChemicalSafetyCertificateModalComponent, { size: 'xl' });
  ...
  exportFile() {
    ...
    const fileName = "Danhsachdoanhnghiepathc_" + timeString + ".xlsx"
    ...
    this.http.post(`${environment.apiUrl}/ChemicalSafetyCertificate/ExportExcel`, query,
    {
      responseType: 'blob',
    }).pipe(
