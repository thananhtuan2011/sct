...
export class StatisticalImportExportProvincialPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/StatisticalImportExportProvincial`;
