...
@Component({
  selector: 'app-edit-rp-promotion-commerce-modal.component',
  templateUrl: './edit-RP-promotion-commerce-modal.component.html',
  styleUrls: ['./edit-RP-promotion-commerce-modal.component.scss'],
})

export class EditReportPromotionCommerceModalComponent implements OnInit, OnDestroy {
  @Input() id: any;
  isLoading$: any;
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      business: [this.ReportPromotionCommerceData.business, Validators.required],
      host: [this.ReportPromotionCommerceData.host, Validators.required],
      chief: [this.ReportPromotionCommerceData.chief, Validators.required],
      organize: [this.ReportPromotionCommerceData.organize, Validators.required],
      address: [''],
      location: [this.ReportPromotionCommerceData.location, Validators.required],
      scale: [this.ReportPromotionCommerceData.scale, Validators.required],
      resultNote: [this.ReportPromotionCommerceData.resultNote, Validators.required],
      projectName: [this.ReportPromotionCommerceData.projectName, Validators.required],
      position: [this.ReportPromotionCommerceData.position, Validators.required],
      represent: [this.ReportPromotionCommerceData.represent, Validators.required],
      phonenumber: [this.ReportPromotionCommerceData.phoneNumber, Validators.required],
      startTime: [this.ReportPromotionCommerceData.startTime, Validators.required],
      endTime: [this.ReportPromotionCommerceData.endTime, Validators.required],
