...
import { EditBusinessModalComponent } from './table-business-page/components/edit-business-modal/edit-business-modal.component';
...
@NgModule({
  declarations: [
    ...
    TableBusinessPageComponent,
    EditBusinessModalComponent,
    InfoBusinessPageComponent,
  ],
  providers: [
    BusinessPageService,
    MatNativeDateModule,
