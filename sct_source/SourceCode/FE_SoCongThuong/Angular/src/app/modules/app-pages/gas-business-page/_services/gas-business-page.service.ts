...
export class GasBusinessPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/GasBusiness`;
  ...
  getAllGasBusiness(): Observable<any> {
    const httpHeaders = this.auth.getHTTPHeaders();
    const url = `${environment.apiUrl}/Gas/findAll`;
