...
@Component({
  selector: 'app-edit-supermarket-modal',
  templateUrl: './edit-supermarket-modal.component.html',
  styleUrls: ['./edit-supermarket-modal.component.scss'],
})

export class EditCommercialManagementSuperMarketModalComponent implements OnInit, OnDestroy {
  @Input() id: any;
  @Input() typeId: any;
  @Input() code: any;
  @Input() name: any;
  ...
  create() {
    // console.log('Create: ',this.commercialmanagementData);
