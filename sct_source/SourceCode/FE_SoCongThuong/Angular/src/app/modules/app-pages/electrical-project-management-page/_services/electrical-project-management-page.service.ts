...
export class ElectricalProjectManagementPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/ElectricalProjectManagement`;
