...
export class TestGuidManagementPageService extends TableService<any> implements OnDestroy {
  API_URL = `${environment.apiUrl}/TestGuidManagement`;
  ...
  deleteTestGuidManagement(id: string): Observable<any> {
    // console.log('delete: ',id);
    const httpHeaders = this.auth.getHTTPHeaders();
    const url = `${this.API_URL}/deleteTestGuidManagement/${id}`;
