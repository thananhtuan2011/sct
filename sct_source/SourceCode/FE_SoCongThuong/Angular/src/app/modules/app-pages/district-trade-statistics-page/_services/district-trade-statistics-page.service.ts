...
export class DistrictTradeStatisticsPageService extends TableService<any> implements OnDestroy {
  ...
  public loadData(tableState: any) {
    ...
    return this.http.post<any>(this.API_URL + '/StatisticalByCommune',
      tableState,
      { headers: httpHeaders }
    );
  }
