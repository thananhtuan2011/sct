...
namespace API_SoCongThuong.Controllers
{
    ...
    [ApiController]
    public class CateRPTurnOverIndustAncolController : ControllerBase
    {
        private CateRPTurnOverIndustAncolRepo _repo;
        private IConfiguration _configuration;
        private readonly ILogger<AsyncLogger> _logger;
        public SoHoa_SoCongThuongContext _context;
        private AsyncLogger _asyncLogger;

        public CateRPTurnOverIndustAncolController(SoHoa_SoCongThuongContext context, IConfiguration configuration, ILogger<AsyncLogger> logger)
        {
            _repo = new CateRPTurnOverIndustAncolRepo(context);
        ...
        public IActionResult ListItems_New([FromBody] QueryRequestBody query)//query truyền lên
        {
            ...
            BaseModels<CateReportTurnOverIndustAncolModel> model = new BaseModels<CateReportTurnOverIndustAncolModel>();
            ...
            try
            {
                ...
                Func<CateReportTurnOverIndustAncolModel, object> _orderByExpression = x => x.CateReportTurnOverIndustAncolId; //Khởi tạo mặc định sắp xếp dữ liệu
                Dictionary<string, Func<CateReportTurnOverIndustAncolModel, object>> _sortableFields = new Dictionary<string, Func<CateReportTurnOverIndustAncolModel, object>>   //Khởi tạo các trường để sắp xếp
                    {
                ...
                //IQueryable<CateReportTurnOverIndustAncolModel> _data = _repo._context.CateReportTurnOverIndustAncols.Where(x => !x.IsDel).GroupJoin(
                //    _repo._context.Users,
                //    cc => cc.CreateUserId,
                //    u => u.UserId,
                //     (cc, u) => new { cc, u }).SelectMany(result => result.u.DefaultIfEmpty(), (info, us)
                //     => new CateReportTurnOverIndustAncolModel
                //     {
                //         CateReportTurnOverIndustAncolId = info.cc.CateReportTurnOverIndustAncolId,
                ...
                var _data = (from cc in _repo._context.CateReportTurnOverIndustAncols
                             where !cc.IsDel
                             join u in _repo._context.Users on cc.CreateUserId equals u.UserId into cu
                             from us in cu.DefaultIfEmpty()
                             join b in _repo._context.Businesses on cc.BusinessId equals b.BusinessId into JoinBusiness
        ...
        [HttpPost()]
        public async Task<IActionResult> Create(CateReportTurnOverIndustAncolModel data)
        {
            BaseModels<CateReportTurnOverIndustAncolModel> model = new BaseModels<CateReportTurnOverIndustAncolModel>();
            try
            {
                ...
                datalog = Ulities.WriteLog(_configuration, HttpContext, loginData.Username, ActionType_Const.CREATE, NameCategory_Const.CATE_RP_TURN_OVER_INDUST_ANCOL, Action_Status.SUCCESS);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(CateReportTurnOverIndustAncolModel data)
        {
            BaseModels<CateReportTurnOverIndustAncolModel> model = new BaseModels<CateReportTurnOverIndustAncolModel>();
            try
            {
                ...
                SystemLog datalog = new SystemLog();
                var CheckData = _repo.FindById(data.CateReportTurnOverIndustAncolId);
                if (CheckData == null)
                {
                    ...
                    datalog = Ulities.WriteLog(_configuration, HttpContext, loginData.Username, ActionType_Const.UPDATE, NameCategory_Const.CATE_RP_TURN_OVER_INDUST_ANCOL, Action_Status.FAIL);
                    _asyncLogger.LogInfo(JsonConvert.SerializeObject(datalog));
                    return BadRequest(model);
                }
                else
                {
                    ...
                    datalog = Ulities.WriteLog(_configuration, HttpContext, loginData.Username, ActionType_Const.UPDATE, NameCategory_Const.CATE_RP_TURN_OVER_INDUST_ANCOL, Action_Status.SUCCESS);
                    _asyncLogger.LogInfo(JsonConvert.SerializeObject(datalog));
                }
                model.status = 1;
                return Ok(model);
        ...
        public IActionResult getItemById(Guid id)
        {
            ...
            try
            {
                ...
                CateReportTurnOverIndustAncolModel result = new CateReportTurnOverIndustAncolModel()
                {
                    CateReportTurnOverIndustAncolId = info.CateReportTurnOverIndustAncolId,
        ...
        public async Task<IActionResult> delete(Guid id)
        {
            ...
            try
            {
                ...
                datalog = Ulities.WriteLog(_configuration, HttpContext, loginData.Username, ActionType_Const.DELETE, NameCategory_Const.CATE_RP_TURN_OVER_INDUST_ANCOL, Action_Status.SUCCESS);
                _asyncLogger.LogInfo(JsonConvert.SerializeObject(datalog));
        ...
        public IActionResult Export([FromBody] QueryRequestBody query)
        {
            ...
            try
            {
                using (var workbook = new XLWorkbook(@"Upload/Templates/Baocaokinhdoanhruoucongnghiep.xlsx"))
                {
